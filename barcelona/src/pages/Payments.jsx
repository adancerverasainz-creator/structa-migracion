      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {(() => {
              const getAmt = (p) => p.paid_amount !== undefined ? (p.paid_amount ?? 0) : (p.amount || 0);
              const allPayments = [...payments, ...generalPayments, ...tournamentPayments, ...leaguePayments, ...summerCampPayments.filter(p => p.status === 'pagado')];
