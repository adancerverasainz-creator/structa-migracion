...
export default function Dashboard() {
  ...
  // Ingresos de pagos mensuales (solo mensualidad, inscripcion, reinscripcion, uniformes — separados por tipo)
  const monthlyPayments = payments.filter(p => filterByPeriod(p.payment_date));
  ...
  const calculateAccountBalances = () => {
    ...
    const allPayments = [...payments, ...tournamentPayments, ...leaguePayments, ...generalPayments, ...scPaid];
